...
// Instagram: Updated to Solid Filled Shape
const IconInstagram = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    ...
    {/* Fill the background square to make it "Solid" */}
    ...
    <footer className="bg-black text-white pt-16 md:pt-24 pb-8 md:pb-12 border-t border-white/5" id="footer">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12 mb-12 md:mb-16">
           ...
           {/* Social Icons (Refactored to Solid) */}
              ...
              <div className="flex gap-4">
                 {SOCIAL_LINKS.map(({ icon: Icon, label, href }) => (
                    <a
                      ...
                      href={href}
                      aria-label={label}
                      className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/5 border border-white/10 text-white/70 flex items-center justify-center hover:bg-white hover:text-[#1a2e29] hover:scale-110 transition-all duration-300 active:scale-95 shadow-sm"
                    >
