...
const About: React.FC = () => {
  return (
    <section className="py-16 md:py-32 border-t border-black/5 scroll-mt-20 md:scroll-mt-32" id="about">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-10 lg:gap-x-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 md:gap-8 lg:pl-6 order-1 lg:order-2">
            ...
            <div className="pt-4 md:pt-6">
               <button className="flex items-center gap-3 bg-[#1a2e29] text-white pl-6 pr-2 py-2 rounded-full hover:bg-black transition-colors active:scale-95 group/btn w-fit shadow-lg">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4 md:gap-6 order-2 lg:order-3">
             {/* Feature Card 1 */}
             <div className="bg-[#f6f7f7] rounded-[24px] p-6 md:p-8 flex flex-col gap-4 md:gap-6 hover:bg-[#f0f0f0] transition-colors cursor-default border border-transparent hover:border-black/5">
             ...
             {/* Feature Card 2 */}
             <div className="bg-[#e9f5d3] rounded-[24px] p-6 md:p-8 flex flex-col gap-4 md:gap-6 hover:bg-[#dbecc2] transition-colors cursor-default border border-transparent hover:border-[#cfe7a7]">
